  ...
  <div class="container">
    <section class="task-block">
      <div class="task-block__content">
        <div class="task-block__header">
          <div class="task-tools">
            ...
            <div class="task-tools__wrapper">
              <span class="priority priority_hight"> Hight </span>
              <span class="priority priority_medium"> Medium </span>
              <span class="priority priority_low"> Low </span>
            </div>
          </div>
        ...
        <div class="editor">
          <label class="label" for="task_name">Task name*</label>
          <input
            ...
            required
          />
          <span class="editor__subtext">0/100</span>
        </div>
        <div class="editor">
          ...
          <textarea
            ...
            id="description"
          ></textarea>
          <span class="editor__subtext">0/280</span>
        </div>
        <div class="task-block__options">
          <div class="task-tools">
            ...
            <div class="task-tools__wrapper">
              ...
              <label
                for="piblic"
                class="task-tools__elem task-tools__default task-tools__default_checked"
                >Public</label
              >
              <input
                class="task-tools__elem"
              ...
              <label
                for="privacy"
                class="task-tools__elem task-tools__default"
                >Privacy</label
              >
            </div>
          </div>
          ...
          <div class="task-tools">
            ...
            <div class="task-tools__wrapper">
              <div class="selection selection_edit">
                <div class="user-icon">
                  <svg
          ...
          <div class="task-block__options-elem">
            <span class="task-block__subtitle task-block__subtitle_edit"
              >Files</span
            >
            <div class="file">
              <span class="file__name file__name_edit">homework.rar</span>
              <svg
                width="13"
                height="13"
                viewBox="0 0 13 13"
        ...
        <div class="task-block__btn">
          ...
          <button class="button button_primary" type="button">Save</button>
        </div>
          ...
          <div class="comment">
            <div class="comment__header">
              ...
              <div class="comment__time">
                <time datetime="2023.02.25Т23:22">25.02.2023 23:22</time>
              </div>
            </div>
            <div class="comment__message">Deadline Is Coming</div>
          </div>
          <div class="comment">
            <div class="comment__header">
              <div class="user-icon">
